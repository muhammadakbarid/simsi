...
(8, 16, 2, 40, 'fas fa-bars', 'Kelola Sidebar', 'cms/menu/side-menu', 'navMenu', 1),
(40, 15, 1, 0, 'empty', 'DEV', '#', '#', 1),
(42, 12, 2, 115, 'fas fa-users-cog', 'User dan Group', '#', '1', 1),
(43, 13, 3, 42, 'fas fa-user-plus', 'Kelola Users', 'users', '1', 1),
(44, 14, 3, 42, 'fas fa-users', 'Kelola Groups', 'groups', '2', 1),
