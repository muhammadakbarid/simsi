    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6"> <?php echo lang('create_user_phone_label', 'phone'); ?> <br />
        ...
        <div class="row">
          ...
          <div class="col-md-6"> <?php echo lang('create_user_jabatan_label', 'jabatan'); ?> <br />
            <?php echo form_input($jabatan); ?></div>
        </div>
        <br>
        <div class="row">
          <div class="col-md-6">
