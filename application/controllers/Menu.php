    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            foreach ($id_groups as $key => $value) {
                $this->db->query("insert into groups_menu (id_groups,id_menu) values ('$value', '$idmenu')");
            }
            //echo $idmenu;
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            foreach ($id_groups as $key => $value) {
                ...
                $this->db->query("insert into groups_menu (id_groups,id_menu) values ('$value', ' $id_menu')");
            }
